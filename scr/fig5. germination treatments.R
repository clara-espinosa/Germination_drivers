...
finalgerm %>%
  ...
  geom_segment (aes(x= 1,xend =2,  y = 0.47, yend= 0.47), color = "black", linewidth = 0.3, show.legend = F)+
  annotate ("text", x= 1.5, y= 0.48, label = "***", size= 2)+
  geom_segment (aes(x= 1,xend =3,  y = 0.52, yend= 0.52), color = "black", linewidth = 0.3, show.legend = F)+
  annotate ("text", x= 2, y= 0.53, label = "*", size= 2)+
...
ggsave(filename = "Fig5 (2).png", plot =fig4 , path = "results/Figures/", 
