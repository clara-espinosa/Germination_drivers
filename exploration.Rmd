...
Viables calculation per petri dish
```{r}
raw_df %>%
...
Visualization of germination under snow (during cold stratification pre-treatment)
```{r, echo = FALSE}
cold_strat %>%
  group_by (species)%>%
...
Final germination percentage per treatment discounting cold stratification germ 
```{r}
raw_df %>%
